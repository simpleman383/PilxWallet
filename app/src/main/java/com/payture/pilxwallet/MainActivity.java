...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExchangeFragment chartFragment = new ExchangeFragment();
        RateFragment infoFragment = new RateFragment();

        // отображаем фрагменты
        getSupportFragmentManager().beginTransaction().replace(R.id.main_frame, chartFragment).commit();
        getSupportFragmentManager().beginTransaction().replace(R.id.rates_frame, infoFragment).commit();
